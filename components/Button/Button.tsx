...
const StyledButton = styled.div<{ variant: string }>`
    ...
    background-image: linear-gradient(${({ variant }) => styleVariants[variant].backgroundColor}, ${({ variant }) => styleVariants[variant].backgroundColor}), linear-gradient(${({ variant }) => styleVariants[variant].backgroundColor},${({ variant }) => styleVariants[variant].backgroundColor}), linear-gradient(${({ variant }) => styleVariants[variant].backgroundColor}, ${({ variant }) => styleVariants[variant].backgroundColor}),
        linear-gradient(${({ variant }) => styleVariants[variant].backgroundColor},${({ variant }) => styleVariants[variant].backgroundColor}),
        linear-gradient(
            to bottom left,
    ...
    a {
        ...
        padding: 0 18px;
        background-image: linear-gradient(-135deg, transparent 4px, ${({ variant }) => styleVariants[variant].backgroundButton} 0),
        ...
        &:hover,
        &:active {
            background-image: linear-gradient(-135deg, transparent 4px, ${({ variant }) => styleVariants[variant].backgroundColor} 0),
